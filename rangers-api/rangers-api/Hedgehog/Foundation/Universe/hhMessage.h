...
namespace hh::fnd
{
	enum class MessageID : uint32_t {
		...
		ANIMATION_TRIGGER = 1024,
		ANIMATION_OVERFLOW = 1025,
		...
		BEGIN_EXTERNAL_CONTROL = 8249,
		BEGIN_FLY_ON_PATH = 8252,
		BEGIN_HIT_STOP = 8253,
		BEGIN_HIT_STOP_BY_NAME = 8254,
		BEGIN_NOTIFY_TARGET_ACTION = 8255,
		...
		CHANGE_DAMAGE_STATE = 8385,
		CHANGE_GLOBAL_TIME_SCALE = 8387,
		CHANGE_LAYER_TIME_SCALE = 8388,
		CHANGE_PLAYER_CHARACTER = 8392,
		TRANSFORM_TO_SS2 = 8397,
		CHARACTER_BEGIN_LOOK_AT = 8399,
		CHARACTER_END_LOOK_AT = 8400,
		CHARACTER_RESET_LOOK_AT = 8401,
		CHARACTER_SET_LOOK_AT = 8402,
		CLEAR_ISLAND = 8404,
		COLLIDER_QUERY_ENTER = 8406,
		COLLIDER_QUERY_LEAVE = 8407,
		COLLIDER_QUERY_STAY = 8408,
		COLLISION_ENABLE = 8409,
		COLLISION_ENTER_IN_CY_BLASTER = 8410,
		COLLISION_ENTER_WHILE_FALLING = 8411,
		DAMAGE = 8428,
		DEAD = 8429,
		DEAD_TUTORIAL_ENEMY = 8430,
		DEBUG_NOTIFY_WARP = 8441,
		DEBUG_SET_PLAYER_POSITION = 8443,
		TRANSFORM_FROM_SS2 = 8449,
		...
		END_BOSS_RING_SUPPLY = 8489,
		END_EVENT_GIMMICK_PREVIEW = 8495,
		END_EXTERNAL_CONTROL = 8496,
		...
		FISHING_CHANGE_CAMERA_MODE = 8564,
		FISHING_RETURN_TO_ISLAND = 8567,
		...
		SHAKE_CAMERA_NAME = 8960,
		SHOW_KODAMA = 8974,
		SPAWN_MINIBOSS_CHARGER_GRIND_GIMMICK = 8987,
		SPRING_IMPULSE = 8989,
		SPRING_ROUTE = 8990,
		...
		UI_BOSS_LIFE_GAUGE_APPEAR = 9112,
		UI_BOSS_LIFE_GAUGE_DISAPPEAR = 9113,
		UI_BOSS_LIFE_GAUGE_VISIBILITY = 9115,
		UI_CAMERA_INFO = 9117,
		UI_CAUTION_NAVIGATION_IN = 9118,
		UI_CHANGE_PLAYER_CHARACTER = 9120,
		UI_CHARACTER_ACTION_GUIDE = 9122,
		UI_CHARACTER_ACTION_GUIDE_END = 9123,
		UI_END_GAME_COCKPIT_DESTINATION = 9131,
